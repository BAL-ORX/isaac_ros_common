...
default_config_path="/home/$USER/dev/orx/data/experiment_config/${SELF_DATAHUB}/clarius_config"
...
docker run --rm -it --gpus all --runtime=nvidia \
    ...
    -v "$config_path":/home/admin/clarius_config \
    girf/orx-middleware-isaac-ros-"$PLATFORM_NAME"-clarius-ultrasound